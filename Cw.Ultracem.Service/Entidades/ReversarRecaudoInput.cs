...
{
    public class ReversarRecaudoInput
    {
        #region Properties
        ...
        /// <returns></returns>
        public static ReversarRecaudoInput Deserialize(string xml)
        {
            System.Xml.Serialization.XmlSerializer xs = new System.Xml.Serialization.XmlSerializer(typeof(ReversarRecaudoInput));
            TextReader reader = new StringReader(xml);
            ReversarRecaudoInput c = (ReversarRecaudoInput)xs.Deserialize(reader);
            reader.Close();
            return c;
        }
    }
