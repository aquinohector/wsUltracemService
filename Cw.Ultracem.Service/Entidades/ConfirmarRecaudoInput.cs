...
namespace Cw.Ultracem.Service.Entidades
{
    ...
    public class ConfirmarRecaudoInput
    {
        ...
        /// <returns></returns>
        public static ConfirmarRecaudoInput Deserialize(string xml)
        {
            System.Xml.Serialization.XmlSerializer xs = new System.Xml.Serialization.XmlSerializer(typeof(ConfirmarRecaudoInput));
            TextReader reader = new StringReader(xml);
            ConfirmarRecaudoInput c = (ConfirmarRecaudoInput)xs.Deserialize(reader);
            reader.Close();
            return c;
        }
    }
